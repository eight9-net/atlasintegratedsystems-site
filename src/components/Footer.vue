...
<template>
  <footer class="bg-gray-400 text-primary footer-section">
    ...
    <div class="container w-full md:mx-auto">
      <div class="flex flex-col items-center justify-between space-y-8 md:flex-row md:items-start md:space-y-0 md:space-x-8">
        ...
        <div class="w-full p-5 m-0 text-center md:w-1/3">
          <div class="p-5">
        ...
        <div class="w-full p-5 mx-0 text-center md:w-1/3">
          <div class="p-5">
      ...
      <div class="w-full m-0 my-3 text-center">
        <img class="max-w-[200px] lg:max-w-[300px] mx-auto" :src="useGetImageUrl('atlas-logo-sq.svg')" :alt="siteProperties.companyName" />
      ...
      <div class="flex items-center justify-center w-full pb-5 text-lg headline">
        <h2 class="p-2 text-primary text-1xl">Communications Systems Design</h2>
      </div>
    </div>
  </footer>
</template>
