...
<template>
  <section class="hero">
    <div
      class="relative w-full min-h-[640px] overflow-hidden hero"
    ...
    >
      ...
      <div class="text-center hero-content text-neutral-content">
        <div class="w-full max-w-6xl mx-auto">
          <h1 class="mb-5 text-3xl font-normal uppercase headline md:text-5xl">Design. Engineering. Installation.</h1>
          <div class="my-6 mb-5 text-2xl font-light headline">
            Solutions for Every Communications Systems design
          </div>
